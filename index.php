        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          echo '<div class="col-xs-3 col-sm-3 col-md-3">
                  <div class="card" style="width: 18rem;">
                    <img src="img/'.$image_name. '" class="card-img-top" alt="image for this category" width="249px" height="270px">
                    <div class="card-body">
                      <h5 class="card-title"><a href="viewfoodList.php?catid=' . $id . '">' . $cat . '</a></h5>
                      <p class="card-text">' . substr($desc, 0, 30). '... </p>
                      <a href="viewfoodList.php?catid=' . $id . '" class="btn btn-primary">Xem thêm</a>
                    </div>
                  </div>
                </div>';
        }
