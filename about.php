    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Đặt ngay</a>
              </div>
            </div>
          </div>
          <!-- Slide 2 -->
          ...
          <!-- Slide 3 -->
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/img/slide/3.png" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Chào mừng bạn đến với <strong>MÓN VIỆT</strong></h3>
            <p>Nhà hàng của chúng tôi chuyên phục vụ các món ăn chủ yếu là của Việt Nam. Ngoài ra còn phục vụ các món ăn nhanh khác. Chúng tôi luôn luôn lắng nghe các ý kiến từ khách hàng để từ đó không ngừng cải thiện và nâng cao chất lượng dịch vụ.</p>
            <p class="font-italic">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <div class="skills-content">
              <p><b>Đánh giá: </b></p>
              <div class="progress">
                <span class="skill">5 sao <i class="val">93%</i></span>
              ...
              <div class="progress">
                <span class="skill">4 sao <i class="val">90%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">3 sao <i class="val">30%</i></span>
                <div class="progress-bar-wrap">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            ...
            <i class="icofont-restaurant"></i>
              ...
              <p><strong>Chuẩn bị món</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            ...
            <i class="icofont-fast-delivery"></i>
              ...
              <p><strong>Giao hàng đến khách hàng</strong></p>
            </div>
          </div>
     ...
     <section id="team" class="team">
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/4.png" class="img-fluid" alt="" style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Trần Trọng Nghĩa</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="" target="_blank"><i class="fab fa-github"></i></a>
