...
<div class="container-fluid" style="margin-top:98px">
	...
	<div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#newUser"><i class="fa fa-plus"></i> Thêm mới</button>
        </div>
	</div>
	    <br>
	<div class="row">
				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM users LIMIT $item_per_page OFFSET $offset"; 
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/project_php_orderfood/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/project_php_orderfood/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editUser' .$Id. '" type="button">Chỉnh sửa</button>';
                                            if($Id == 1) {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="newUser">Thêm mới người dùng</h5>
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              <div class="form-group">
                  ...
                  <input class="form-control" id="username" name="username" placeholder="Nhập tên đăng nhập" type="text" required minlength="3" maxlength="11">
              </div>
              <div class="form-row">
              ...
              <button type="submit" name="createUser" class="btn btn-success">Thêm mới</button>
            </form>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="editUser<?php echo $Id; ?>" tabindex="-1" role="dialog" aria-labelledby="editUser<?php echo $Id; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="editUser<?php echo $Id; ?>">ID người dùng: <b><?php echo $Id; ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                        <b><label for="image">Hồ sơ ảnh</label></b>
                        ...
                        <button type="submit" class="btn btn-success mt-3" name="updateProfilePhoto">Cập nhật ảnh</button>
                    </form>         
                </div>
                <div class="form-group col-md-4">
                <img src="/project_php_orderfood/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/project_php_orderfood/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-success mt-2" name="removeProfilePhoto">Xóa ảnh</button>
                    </form>
                </div>
            </div>
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                <button type="submit" name="editUser" class="btn btn-success">Cập nhật thông tin</button>
            </form>
        </div>
    </div>
  </div>
