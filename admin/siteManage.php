		...
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                <div class="form-group">
                    <label for="name" class="control-label">Tên nhà hàng</label>
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Hotline</label>
                    <input type="tel" class="form-control" id="contact1" name="contact1" value="' .$contact1. '" required>
                </div>
                <div class="form-group">
                    <label for="contact" class="control-label">CSKH</label>
                ...
                <center>
                    <button name="updateDetail" class="btn btn-info btn-primary btn-block col-md-2">Lưu</button>
                </center>
            </form>
		</div>
	</div>';
