        ...
        <table class="table table-striped table-hover text-center" id="NoOrder">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM `orders` LIMIT $item_per_page OFFSET $offset";
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo '<tr>
                                ...
                                <td>' . $paymentMode . '</td>
                                <td>' . $orderDate . '</td>
                                <td><a href="#" data-toggle="modal" data-target="#orderStatus' . $orderId . '" class="view"><i class="material-icons">room_service</i></a></td>
                                <td><a href="#" data-toggle="modal" data-target="#orderItem' . $orderId . '" class="view" title="View Details"><i class="material-icons">remove_red_eye</i></a></td>
                            </tr>';
                    }
                    if($counter==0) {
