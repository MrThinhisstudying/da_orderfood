    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(111 202 203);">
                <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Tóm tắt đơn hàng (<b>Mã đặt hàng: <?php echo $orderid; ?></b>)</h5>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $foodImg = $itemrow['foodImg'];
                                        $foodCategorieId = $itemrow['foodCategorieId'];

                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/project_php_orderfood/img/'.$foodImg. '" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$foodName. '</h5><span class="text-muted font-weight-normal font-italic d-block">' .$foodPrice. '₫</span>
                                                    </div>
                                                    </div>
                                                </th>
                                                <td class="align-middle text-center"><strong>' .$itemQuantity. 'x</strong></td>
                                            </tr>';
                                    }
                                ?>
                            </tbody>
