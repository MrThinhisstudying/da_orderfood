...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            ...
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `food` WHERE foodCategorieId = $id LIMIT $item_per_page OFFSET $offset ";
            $totalrecords = mysqli_query($conn, "SELECT * FROM food  WHERE foodCategorieId = $id");
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            <img src="img/'.$foodImg. '" class="card-img-top" alt="image for this food" width="249px" height="270px">
                            <div class="card-body">
                            ...
                            echo '</form>                            
                                <a href="viewfood.php?foodid=' . $foodId . '" class="mx-2"><button class="btn btn-primary">Xem thêm</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <p class="display-4">Xin lỗi món ăn bạn tìm không có trong thực đơn.</p>
                        <p class="lead">Chúng tôi sẽ sớm cập nhật thêm. Rất xin lỗi vì sự bất tiện này.</p>
                    </div>
                </div> ';
            }
            ?>
        ...
        <div class="text-center" style="margin-top:20px">
                        <?php require 'partials/_pagination.php' ?>
