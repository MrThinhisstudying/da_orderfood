        ...
        <div class="row">
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST">
                        <small>Xóa ảnh: </small><button type="submit" class="btn btn-primary" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;">Xóa</button>
                    </form>
                    <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                        <div class="upload-btn-wrapper">
                            ...
                            <button class="btn upload">chọn</button>
                            <input type="file" name="image" id="image" accept="image/*">
                        </div>
                        <button type="submit" name="updateProfilePic" class="btn btn-primary" style="margin-top: -20px;font-size: 15px;padding: 3px 8px;">Cập nhật</button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="name">Họ Tên: <?php echo $firstName." ".$lastName; ?>
                            <label class="label label-info">(<?php echo $userType ?>)</label>
                        </li>
                        <li class="email">Email: <?php echo $email ?></li>
                        <li class="my-2"><a href="partials/_logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Đăng xuất</button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    <h2 class="title text-center">Thông tin cá nhân<span class="pro-label label label-warning"> (<?php echo $userType ?>)</span></h2>
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <button type="submit" name="updateProfileDetail" class="btn btn-primary">Cập nhật thay đổi</button>
                    </form>
                </div>
            </div>
        </div>
