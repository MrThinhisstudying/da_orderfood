...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
                <img src="img/'.$foodImg. '" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $foodName . '</h3>
                <h5 style="color: #ff0000">'.$foodPrice. ' VND</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-primary my-2">Đặt hàng</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-primary my-2">Đến giỏ hàng</button></a>';
                    }
                }
                else{
                    echo '<button class="btn btn-primary my-2" data-toggle="modal" data-target="#loginModal">Đặt hàng</button>';
                }
                echo '</form>
                <h6 class="my-1"> Quay lại </h6>
                <div class="mx-4">
